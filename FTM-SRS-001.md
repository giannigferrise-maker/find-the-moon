...
| FTM-VT-008 | The system shall render daytime animated clouds using the fill color #FFB347 (soft peach orange / rgba(255,179,71)) | Test |
...
> v1.6 (Mar 23, 2026) — Amendment F: updated FTM-VT-008 cloud fill color from lavender (#c9b8e8) to soft peach orange (#FFB347 / rgba(255,179,71)) per Issue #54. No other changes.
